---
name: dev-team-1
description: Use this agent to implement the code for a sprint, write tests, and fix issues raised by QA1 or QA-Auto. Use during the build phase of a sprint and during both fix loops.
model: sonnet
color: red
---
...
3. Identify integration points with anything Dev Team 2 is assigned
...
### Integration Points
[Where your code meets Dev Team 2's work, if applicable.]
