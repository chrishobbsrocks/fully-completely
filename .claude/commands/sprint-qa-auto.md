---
description: "QA-Auto: record the live browser test verdict"
allowed-tools: [Bash, Write]
---

# QA-Auto Live Test

Usage: `/sprint-qa-auto <sprint-id> --verdict PASS|FAIL|CONDITIONAL --notes "..."`
...
```bash
python3 scripts/sprint_lifecycle.py qa-auto <sprint-id> --verdict <verdict> --notes-file /tmp/qa-auto-notes.txt
```
